...
module Log4r
  ...
  class Logger
    ...
    def self.finalize_parsers!
      @parsers||=[::Log4r::ArgParser.new,::Log4r::ExceptionParser.new]
      @parsers.freeze
    end
    ...
    def initialize(_fullname, _level=nil, _additive=true, _trace=false)
      # validation
      raise ArgumentError, "Logger must have a name" if _fullname.nil?
    ...
    def validate_name(_fullname)
      ...
      for part in parts
        raise ArgumentError, "Malformed path" if part.empty?
      end
    end
